    ...
    class Menu {
        constructor(el) {
            ...
            this.DOM.openCtrl.addEventListener('mouseenter', () => {
                ...
                TweenMax.to(this.DOM.openCtrl, action === 'close' ? 0.6 : 0.6, {
                delay: action === 'close' ? 0 : 0,
                ease: action === 'close' ? Power0.easeIn : Power0.easeIn,
                opacity: action === 'close' ? 0.3 : 0.3
            	});
            	allowTilt = false;
                tilt.reset();
            });
			...
			this.DOM.openCtrl.addEventListener('mouseleave', () => {
               TweenMax.to(this.DOM.openCtrl, action === 'close' ? 0.4 : 0.4, {
                delay: action === 'close' ? 0 : 0,
                ease: action === 'close' ? Power0.easeIn : Power0.easeIn,
        ...
        toggle(action) {
            ...
            this.DOM.openCtrl.addEventListener('mousemove', () => {
               TweenMax.to(this.DOM.openCtrl, action === 'close' ? 0.4 : 0.4, {
                delay: action === 'close' ? 0 : 0,
                ease: action === 'close' ? Power0.easeIn : Power0.easeIn,
                opacity: action === 'close' ? 0.3 : 0.3
            ...
            TweenMax.to(this.DOM.openCtrl, action === 'open' ? 0.3 : 0.3, {
   ...
   class TiltFx {
        ...
        layout() {
            ...
            for (let i = 0; i <= this.layersTotal-1; ++i) {
                inner +=  '<div class="background__copy" style="background-image: url(/wp-content/themes/techiereef/uploads/bg-manta.jpg)"></div>';
            }
        ...
        zoom() {
            TweenMax.staggerTo( this.DOM.layers, 0.4, {
                ease: 'Expo.easeOut',
                x: 0,
                y: 0,
                rotationX: 0,
        ...
        reset() {
            TweenMax.staggerTo( this.DOM.layers, 0.8, {
                ease: 'Expo.easeOut',
                x: 0,
                y: 0,
                rotationX: 0,
