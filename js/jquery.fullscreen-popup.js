  ...
  (function($) {
    ...
    FSP = (function() {
      ...
      FSP.prototype.getTarget = function() {
        ...
        var bigimg = $(this.element).attr('data-url');
        this.target.empty();
		this.target.html('<img src="'+bigimg+'" />');
      ...
      FSP.prototype.createWrappers = function() {
        ...
        this.contentWrapper = $("<div/>", {
          ...
          "style": "width: " + this.targetSizes.width + "px; height: " + this.targetSizes.height + "px;  position: absolute; left: 50%; margin-left: -" + (this.targetSizes.width / 2) + "px;"
